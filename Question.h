...
// Seat Management: Each Seat must have Id A1,A2....// No of quantioty of seats
//                       Seat Type:Regular/Premium
//                       Price,Status:Available or not.
// Operation: View Available Seat
//            Book Seat
//            Cancellation
//            View Booking Details


// Bussiness:  Booking must Failed if any seat ID is invalid or already Booked
//             Cancelling a Booking shpould all seat again.
//             Total Price can be calaculated Again.


// Exception Handling: Handling Invalid Seating ID.
//                     Handle Booking of already Booked seat.
//                     Handle Cancellatio9n of Non-Booked Seat.


// Data Storage: Use java Collection Map List and follow OOP's Concept.
